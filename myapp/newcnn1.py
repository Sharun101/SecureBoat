...
def read_dataset(path):
    data_list = []
    label_list = []
    my_list = os.listdir(r'C:\django\PREDICTION\src\static\dataset')
    i=-1
    for pa in my_list:
        i=i+1
        print(pa,"==================")
        for root, dirs, files in os.walk(r'C:\django\PREDICTION\src\static\dataset\\' + pa):

         for f in files:
            file_path = os.path.join(r'C:\django\PREDICTION\src\static\dataset\\'+pa, f)
...
def predict(fn):
    ...
    dataset=dataset/255
    mo = load_model(r"C:\django\boating_system\marine_tracking\model1.h5")
...
print(predict(r"C:\django\PREDICTION\src\static\dataset\unsafe\00372.jpg"))